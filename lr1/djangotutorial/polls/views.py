...
SLOGANS = [
    "Есть мнение? Есть опрос! Пройдите его первым.",
    "Несколько кликов — большой вклад. Помогите стать лучше.",
    "Ваше мнение — ключ к лучшим решениям. Поделитесь им за минуту!"
]
